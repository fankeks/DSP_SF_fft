...
def dec_to_pol(x, y):
    ...
    if ((x >= 0) & (y >= 0)):
        ...
        x_cor = -x + y
        y_cor = -x + -y
        ph = (135 - 180) / 180 * np.pi
    elif ((x < 0) & (y < 0)):
        x_cor = -x - y
        y_cor = x - y
        ph = (225 - 180) / 180 * np.pi
    elif ((x >= 0) & (y < 0)):
        x_cor = x - y
        y_cor = x + y
...
if __name__ == '__main__':
    ...
    print(135)
    val = np.uint32(float_to_fix((135-180) / 180 * np.pi, 30))
    print(str(hex(val))[2:])
    print(225)
    val = np.uint32(float_to_fix((225-180) / 180 * np.pi, 30))
    print(str(hex(val))[2:])
    print(315)
    val = np.uint32(float_to_fix((315-360) / 180 * np.pi, 30))
    print(str(hex(val))[2:])
